...
void innerspace(){
    ...
    if (spacechoose == 1){
        ...
        if (giantfans == 1) {
            ...
            cout << "You then get drawn into a room.\n";
...
case 8: {
    ...
    if (basrand == 1){
        ...
        health = health - (5 - def);
        cout << "It stings you!!!!! You take 5 damage. Your health is: " << health << endl;
        if (health > 0) {
            Basement();
        }
        else {
...
int main() {
cout << "--------------------------------------------------------------- \n";
cout << "Maze Game Version 3.1.0 With Western Pacific Universe\n";
cout << "By FanFan61618\n";
cout << "--------------------------------------------------------------- \n";
...
default: {
    ...
    while (turns_used < 6) {
        ...
        if (battle_1 == 1) {
            ...
            cout << "You swing your hatchet through the dog, causing it to vanish.\n";
