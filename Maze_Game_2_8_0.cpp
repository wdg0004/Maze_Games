...
void Elevator(){
 ...
 //Space_Warp();
Basement();
 // Uncomment Basement and comment space warp when basement is created.
}
void Basement(){
...
case 8: {
    ...
    int basrand;
    srand(time(NULL));  // The random sequence is different each time
    basrand = rand() %10 +1; // generates a random number
    if (basrand == 1){
        ...
        cout << "There is a time singularity. It Explodes. Suddenly it is pitch black and silent............. \n";
        Space_Warp();
    }
    else if (basrand == 9){
        cout << "The noise stops, you whuf and then leave. \n";
...
int main() {
cout << "--------------------------------------------------------------- \n";
cout << "Maze Game Version 2.8.0 With Western Pacific Universe\n";
cout << "By FanFan61618\n";
cout << "--------------------------------------------------------------- \n";
...
case 301:
    ...
    break;
default:
    cout << "The dogs break through the fire door, they rush at you. You died.";
