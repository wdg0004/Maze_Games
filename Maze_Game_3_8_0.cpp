    ...
    if (spacechoose == 1){
        ...
        if (giantfans == 1) {
            ...
            if (tunnelselect == 1) {
                ...
                cout << "The fan suddenly speeds up and blows you away, you swerve to go through the top right tunnel, the tunnel curves gradually right then runs straight for a very long time \n";
...
int main() {
cout << "--------------------------------------------------------------- \n";
cout << "Maze Game Version 3.8.0 With Western Pacific Universe\n";
cout << "By FanFan61618\n";
cout << "--------------------------------------------------------------- \n";
