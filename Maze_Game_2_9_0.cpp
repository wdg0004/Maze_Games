...
void mech_chase(){
    ...
    if (pipe_choose == 1) {
        ...
        cout << "You walk around a corner, and down the hall. There are huge centipedes in the hall. One of them bites you on the leg. \n";
        cout << "You double over and squeal. Everything begins to reset.\n";
        Space_Warp();
    }
...
case 8: {
    ...
    int basrand;
    srand(time(NULL));  // The random sequence is different each time
    basrand = rand() %30 +1; // generates a random number
    if (basrand == 1){
...
int main() {
cout << "--------------------------------------------------------------- \n";
cout << "Maze Game Version 2.9.0 With Western Pacific Universe\n";
cout << "By FanFan61618\n";
cout << "--------------------------------------------------------------- \n";
...
cout << "Type 1 to head to the basement, enter a room number to try to enter it, entering invalid input is deadly. \n";
int althall1;
cin >> althall1;
switch (althall1) {
case 1:
...
case 105:
    ...
    cout << "A broken microwave pulses erratically and noisily in one corner.\n ";
...
case 106:
    ...
    cout << "The ceiling is beige, and the closet does not open. You find the room useless. Your head throbs and hurts.\n";
    ...
    break;
case 107:
    cout << "The handle spins in circles while doing nothing. You head to the basement... \n";
...
case 301:
    ...
    break;
default:
    cout << "The dogs break through the fire door, they rush at you. You died. Game Over!!!!!! ";
    cout << "Press 1 to restart game. Press any other number to quit. \n";
    cin >> finalchoose;
    if (finalchoose == 1) {
        Space_Warp();
    }
