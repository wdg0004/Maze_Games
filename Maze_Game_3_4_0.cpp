...
cout << "There are food service windows linking to room 103. There is a gas stove in the room, a beige microwave, and a closet. \n";
...
int main() {
cout << "--------------------------------------------------------------- \n";
cout << "Maze Game Version 3.4.0 With Western Pacific Universe\n";
cout << "By FanFan61618\n";
cout << "--------------------------------------------------------------- \n";
