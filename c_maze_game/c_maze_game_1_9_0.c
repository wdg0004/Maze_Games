...
// state matrix
bool mazestart = true;
char FirstName[25] = "default";
char LastName[25] = "default";
// static variables are private
// they are only accessible in this file
static int playerhealth = 256;
...
// Scanf String: https://stackoverflow.com/questions/35103745/read-a-string-as-an-input-using-scanf
// Flush input buffer: https://stackoverflow.com/questions/7898215/how-can-i-clear-an-input-buffer-in-c
...
int main() {
  ...
  printf("--------------------------------------------------------------------- \n");
  printf("C Based Maze Game 1.9.0 \n");
...
void hall2space() {
  ...
  switch (choose7) {
    ...
    case 2:
      ...
      printf("The computer screen states \" Welcome %s %s \" \n.", FirstName, LastName);
      printf("There is no prompt. You type on the keyboard and notice no change in the display. \n");
      printf("The lights are on and are very bright. You find a pile of floppy disks on one table. Inserting random disks does nothing. Pressing the power button makes an irritating scream noise. \n");
    ...
    case 6:
      ...
      printf("You search for an essay in english... One paper has the name %s written on it. The rest is undecipheralbe. \n", FirstName);
...
void powerplant() {
  ...
  while (tries < 3) {
    ...
    if (finalchoose == 1) {
      ...
      printf("A warning voice says, \"YOU LOSE\"\n\n\n\n\n ");
      tries = 255;
      break;
    }
