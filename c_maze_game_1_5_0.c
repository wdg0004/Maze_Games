...
int main() {
  printf("--------------------------------------------------------------------- \n");
  printf("C Based Maze Game 1.5.0 \n");
...
void hallloop() {
  ...
  switch (loopchoice) {
    ...
    case 3:
      ...
      printf("You fall, hearing a brief air rushing sound, and then hit the solid steel elevator plate with the most severe pain you ever felt. You shriek briefly! Your vision goes black... \n\n\n\n");
      printf("Everything resets! \n");
      myFunction();
      break;
    case 4:
      printf("This is the controller room for the wheelchair elevator. The cables are missing and some of the equipment is ruined. \n");
      printf("You stare into the cable chase and become dizzy from the drop off... \n");
      printf("It looks like it was overloaded and failed. You realize that it cannot work. you leave... \n\n\n\n");
      hallloop();
      break;
    case 5: {
...
void fourierrear() {
  ...
  if (choose4 == 1) {
    ...
    printf("You stand on it and push buttons. Nothing happens. You then notice a pile of cables next to you... You realize the elevator is broken. \n");
    printf("You then notice the frame is cracked, and the floor is chipped. You leave realizing that the elevator crashed.\n");
