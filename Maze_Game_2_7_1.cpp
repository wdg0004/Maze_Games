...
void Hall_1 () {
    ...
    // cout << "It reads that inputting a number other than 1, 101, 102, 103, 104, 105, 106, 107, 108, 109, 110, or 301 will end the game. \n";
    // cout << "You whuf as you realize that you are inside a video game! \n";
int choose2;
    cin >> choose2;
    switch (choose2) {
case 101:
...
int main() {
cout << "--------------------------------------------------------------- \n";
cout << "Maze Game Version 2.7.1 With Western Pacific Universe\n";
cout << "By FanFan61618\n";
cout << "--------------------------------------------------------------- \n";
...
cout << "Your vision is fuzzy and your hearing is distorted. \n";
cout << "Type 1 to head to the basement, 2 to inspect the door. \n";
int althall1;
cin >> althall1;
switch (althall1) {
case 1:
