...
void Lobby() {
    ...
    cout << "What do you do????? Type 1 to go north, 2 to go south, 3 to go east, 4 to go west, 5 to toggle the fan. \n";
    int choose;
    cin >> choose;
...
int main() {
cout << "--------------------------------------------------------------- \n";
cout << "Maze Game Version 3.3.0 With Western Pacific Universe\n";
cout << "By FanFan61618\n";
cout << "--------------------------------------------------------------- \n";
