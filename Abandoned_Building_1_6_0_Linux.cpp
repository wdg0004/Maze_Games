...
if (stair_choose == 1){
    ...
    sleep(5); // creates a 5 second pause - this is the 5000 number seen in Sleep()
...
int main(){
cout << "--------------------------------------------------------------- \n";
cout << "Abandoned Building Version 1.6.0 With Western Pacific Universe\n";
cout << "By FanFan61618\n";
cout << "--------------------------------------------------------------- \n";
