...
* Citation: https://www.learncpp.com/cpp-tutorial/introduction-to-global-variables/
*/
// Global varaibles
int Horn_State = 0;
int Stair_State = 0;
...
void Room_C() {
    ...
    if (roomc_choose == 1) {
        ...
        if (Horn_State == 0) {
            ...
            cout << "The horn is out of tune and does not play the proper notes. You cannot determine how it is out of tune and nothing sounds right on it. You put it back and leave the room... \n";
            Horn_State = 1;
        }
        else if (Horn_State == 1) {
            cout << "You walk around the room. There is a horn with valves in one corner sitting next to a natural baroque trumpet. You pick up the trumpet and try to play it... \n";
            cout << "The trumpet is in F major and plays a partial scale. You play a loud baroque fanfare. You put the trumpet back. \n";
            Horn_State = 2;
        }
        else {
            cout << "You walk around the room. There is a horn with valves in one corner sitting next to a natural baroque trumpet.\n";
            cout << "You leave as there are no other instruments to play... \n";
        }
        Room_C();
    }
    else {
...
void stairwell(){
    ...
    if (Anne_State == 1) {
        if (Stair_State == 0) {
            cout << "The stairs are solid ice.\n";
            cout << "press 1 to climb them, 2 to leave \n";
            cin >> stair_choose;
            if (stair_choose == 1) {
                cout << "You try to climb the stairs after struggling to balance on the ice...\n";
                sleep(10);
                cout << "You reach the landing part way up... \n\n\n";
                sleep(10);
                cout << "You lose your footing and slide off of the stairs, diving through a hole in the stair rail. \n";
                cout << "Before impact, all goes black...";
                DS_Warp();
            }
            else {
                cout << "You leave the stairwell \n";
                DS_Hall();
            }
        }
        else {
        ...
        if (Stair_State == 0) {
            ...
            cout << "This is a stairwell. The number 2 is by the door and the stairs go down only. They are thawed.\n";
            cout << "There is storage closet nearby. Press 1 to use the stairs, or 2 to leave. \n";
            cin >> stair_choose;
            if (stair_choose == 1) {
                cout << "You walk down the stairs safely. \n";
                cout << "the door says 1, and you open it. You get hit with a blast of warm air. \n";
...
if (pchoose == 1){
    ...
    if (randnum1 == 1){
        ...
        if (Stair_State == 0) {
            ...
            cout << "There is a time singularity. You startle and run to the first floor. \n";
            Anne_State = 1;
            DS_Hall();
        }
    }
...
void DS_Hall(){
    if (DS_State == 0) {
        ...
        cout << "Enter 1-7 for doors 1-7, Type 8 to return to the second floor. \n";
        DS_State = 1;
    }
    else {
        cout << "Downstairs Hall: Enter 1-7 for doors 1-7, Type 8 to return to the second floor. \n";
    }
    int DSChoose;
    // Make an array of locations
    int BookArray[7] = {0,1,0,1,0,0,1};
    cin >> DSChoose;
switch(DSChoose){
case 1:
...
case 6: {
    ...
    if (Room6 == 1) {
        ...
        cout << "You scan and find 7 different items that catch your eye. Input 0-6 for items 1 - 7, 8 or larger to leave, less than 0 to leave. \n";
        int bookshelfpick;
        cin >> bookshelfpick;
        while (true) {
            cout << "You pick up the item... \n";
            if (BookArray[bookshelfpick] == 1) {
                cout << "You elbow the bookcase while trying to look at the item. The desk fan falls on you. \n";
                sleep(3);
                cout<< "You dont feel it! \n";
                Anne_State = 1000;
                break;
            }
            else {
                cout << "The item is not interesting. \n";
                cout << "You put it back \n";
            }
            cin >> bookshelfpick;
            if (bookshelfpick < 0) {
                // break the loop
            ...
            else if (bookshelfpick > 6) {
                // break the loop
                break;
            }
            else {
                cout << "Selecting another book \n";
            }
        }
        if (Anne_State == 1000) {
            DS_Warp();
...
int main(){
cout << "--------------------------------------------------------------- \n";
cout << "Abandoned Building Version 1.9.0 With Western Pacific Universe\n";
cout << "By FanFan61618\n";
cout << "--------------------------------------------------------------- \n";
