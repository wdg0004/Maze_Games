...
if (Choose104 == 1){
    ...
    {
        cout << "The TV makes a pop noise and the lights flash... \n";
    ...
    {
        cout << "A wasp flies into the room. You leave and avoid the wasp. \n";  // Creates a random warp event
        Hall_1();
    }
    else if (randnum1 == 15)
    {
        cout << "There are loud noises. They sound like fans. You wait for them to stop and then leave. \n";  // Creates a random warp event
        Hall_1();
    }
    else if (randnum1 == 16)
    {
        ...
        cout << "A deafening mechanical wahwahwah... sound is heard, then the rumble stops. \n";  // Creates a random warp event
...
void innerspace(){
    ...
    if (spacechoose == 1){
        ...
        cout << "Everything shakes from the rapid pressure fluctuations and extreme sound pressure. \n";
...
int main() {
cout << "--------------------------------------------------------------- \n";
cout << "Maze Game Version 2.11.0 With Western Pacific Universe\n";
cout << "By FanFan61618\n";
cout << "--------------------------------------------------------------- \n";
